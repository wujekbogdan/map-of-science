...
- 8d71b97: - Ship an nginx configuration in the image, so it serves the app on any host. Client routes, cache headers and gzip no longer depend on the platform.
